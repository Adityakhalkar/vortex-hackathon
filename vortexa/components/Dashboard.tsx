...
import { MapPinIcon, CloudRainIcon, TreePineIcon, BellIcon, Cloud, LeafIcon, DropletIcon, Heart, Flame, Shield, Thermometer } from 'lucide-react'
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 cursor-pointer" >
                            {alertItems.map((item) => (
                                ...
                                >
                                    ...
                                    <div className="text-xl font-bold">{cityData[item.jsonSearchQuery]} {item.unit}</div>
                                </motion.div>
                            ))}
                        </div>
                    </motion.div>
